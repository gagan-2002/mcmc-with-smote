...
class MCMC:
    ...
    def sampler(self, w_limit, tau_limit):
        ...
        auc1 = roc_auc_score(y_test, pred_test)
        print('AUC: %.3f' % auc1)
        pred_test=(pred_test>0.5)
        f11 = f1_score(y_test, pred_test, average='weighted')
        print('f1 score weighted:%.3f' % f11)
        f12 = f1_score(y_test, pred_test, average='macro')
        print('f1 score macro:%.3f' % f12)
        f13 = f1_score(y_test, pred_test, average='micro')
        print('f1 score micro:%.3f' % f13)
